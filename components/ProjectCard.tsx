...
const ProjectCard = ({ directionLeft }: Props) => {
  return (
    <motion.div
    ...
    >
      <div className="flex flex-col items-start">
        ...
        <div className="flex flex-row py-4">
          <h3 className="text-gray-500 text-lg font-semibold uppercase mr-3 hover:scale-105 grayscale hover:grayscale-0 ease-in-out transition-all duration-500">
            Project 1
          </h3>
